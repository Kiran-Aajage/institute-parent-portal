...
export class ListStudentComponent implements OnInit, OnDestroy {
    ...
    //         balance: '100',
    //     };
    //     this.tempArr.push(myStudentData);

    //     console.log(myStudentData);
    //     console.log('Checkbox clicked:', students);
    //     this.selectedStudents.push(myStudentData);
    //     console.log(this.selectedStudents);
    //     console.log(this.tempArr);

    //     this.onSelectedStudent.emit(this.tempArr);
    // }
    ...
    showFilter() {
        this.showFilterAndSort = !this.showFilterAndSort;
    }
