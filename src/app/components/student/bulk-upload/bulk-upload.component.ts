...
export class BulkUploadComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.schoolUniqueId = this.stateSvc.getUserData('schoolUniqueId');

        console.log(this.schoolId, this.schoolUniqueId);
    ...
    onUpload(event: UploadEvent) {
        for (let file of event.files) {
            ...
            this.studentBulk.append('uniqueId', this.schoolUniqueId);
